...
import org.jeyzer.profile.data.LockerEntry;
...
public class LockerUpdater extends PatternUpdater{
	
	public LockerUpdater(Document doc) throws InvalidPatternsException {
		super(doc);
	}

	@Override
	public String getName() {
		return PatternUpdater.JZR_LOCKER;
	}
	...
	protected ProfileEntry createProfileEntry(Element node, Element nextNode) throws InvalidProfileEntryException {
		...
		return new LockerEntry(node, nextNode);
	}
